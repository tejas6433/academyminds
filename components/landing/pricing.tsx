...
const PLANS = [
  ...
  },
  {
    ...
    features: [
      '3 live math classes every week',
      'Assignment after every class, reviewed',
      'Class recordings for 30 days',
  ...
  },
  {
    ...
    price: '$79',
    period: 'CAD/mo',
    billingNote: 'Billed $237 every 3 months',
